...
class Pila:
    ...
    def agregar_elementos(self, elemento):
        self.stack.append({'elemento': elemento}) 
...
pilas = Pila()
pilas.agregar_elementos('casa')
pilas.agregar_elementos('perro')
pilas.agregar_elementos('gato')
pilas.agregar_elementos('bicicleta')
pilas.agregar_elementos('pelota')

pilas.mostrar_contenido()
print('------------------')
pilas.quitar_elementos()
